...
module id_ex_reg (
  ...
  input  wire [63:0] IMM,        // CHANGED
  input  wire        wreg,
  input  wire [63:0] rd2,        // CHANGED
  input  wire [63:0] rd1,        // CHANGED
  input  wire [4:0]  rd,
  ...
  output reg  [63:0] IMM_out,    // CHANGED
  output reg         wreg_out,
  output reg  [63:0] rd2_out,    // CHANGED
  output reg  [63:0] rd1_out,    // CHANGED
...
always @(posedge clk) begin
  if (rst) begin
    pc_out       <= 11'd0;
    IMM_out      <= 64'd0;       // CHANGED
    wreg_out     <= 1'b0;
    rd2_out      <= 64'd0;       // CHANGED
    rd1_out      <= 64'd0;       // CHANGED
    rd_out       <= 5'd0;
    func3_out    <= 3'd0;
    func7_out    <= 7'd0;
    ALUsrc_out   <= 1'b0;
