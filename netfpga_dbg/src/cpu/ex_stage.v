...
module ex_stage (
  ...
  input  wire [63:0] IMM_in,     // CHANGED
  input  wire        wreg_in,
  input  wire [63:0] rd2_in,     // CHANGED
  input  wire [63:0] rd1_in,     // CHANGED
  ...
  output wire [63:0] alu_out,    // CHANGED
  output wire [63:0] rd2_out,    // CHANGED
...
// Target calc (extend to 64-bit for the addition, then truncate back for small PC)
wire [63:0] pc_u64;
wire [63:0] base64;
